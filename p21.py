...
def myNetwork():
    ...
    s7.cmd('ifconfig s7 10.0.3.1')
    s18.cmd('ifconfig s18 10.3.0.1')
    s6.cmd('ifconfig s6 10.0.0.1')
    s15.cmd('ifconfig s15 10.2.3.1')
    s2.cmd('ifconfig s2 10.4.1.2')
    s8.cmd('ifconfig s8 10.0.1.1')
    s1.cmd('ifconfig s1 10.4.1.1')
    s19.cmd('ifconfig s19 10.3.3.1')
    s4.cmd('ifconfig s4 10.4.2.2')
    s12.cmd('ifconfig s12 10.1.1.1')
    ...
    s10.cmd('ifconfig s10 10.1.0.1')
    s14.cmd('ifconfig s14 10.2.0.1')
